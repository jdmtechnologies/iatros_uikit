...
/// Igual a [UiTextInput] pero acepta un [focusNode] externo, para que quien
/// lo use pueda controlar el foco explícitamente (p. ej. cadenas de Tab).
class UiFocusableTextInput extends StatelessWidget {
  final String? hint;
  final String? label;
  final int? maxLines;
